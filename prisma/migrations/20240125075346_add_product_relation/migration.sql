...
-- CreateTable
CREATE TABLE `Prodcut_Promotion` (
...
-- AddForeignKey
ALTER TABLE `Prodcut_Promotion` ADD CONSTRAINT `Prodcut_Promotion_product_id_fkey` FOREIGN KEY (`product_id`) REFERENCES `Product`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Prodcut_Promotion` ADD CONSTRAINT `Prodcut_Promotion_promotion_id_fkey` FOREIGN KEY (`promotion_id`) REFERENCES `Promotion`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
